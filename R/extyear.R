...
#'
#' wd: Pasta de trabalho onde estão localizados os dados anuais descompactador
#'
#' Juntar numa mesma dados completos do ano de interesse
#' @name extyear
#' @examples
#' # Loading package
#' library(TissLCA)
#' data <- extyear(280030,"D:/LCA/Dados/TISS/AMBULATORIAL/2019/SE")
#' @importFrom  magrittr %>%
#' @export
extyear <- function(cod_IBGE,wd) {
  library(dplyr)
